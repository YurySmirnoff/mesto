# MESTO
Учебный проект одностраничного интерактивного [WEB-сайта](https://yurysmirnoff.github.io/mesto/), в котором можно добавлять и удалять фотографии, ставить лайки.
